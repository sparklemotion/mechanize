...
class Mechanize::Page < Mechanize::File
  ...
  #
  # Same as +form_with+ but raises an error if no button matches +criteria+
  ...
  #
  # Same as +link_with+ but raises an error if no button matches +criteria+
  ...
  #
  # Same as +base_with+ but raises an error if no button matches +criteria+
  ...
  #
  # Same as +frame_with+ but raises an error if no button matches +criteria+
  ...
  #
  # Same as +iframe_with+ but raises an error if no button matches +criteria+
  ...
  #
  # Same as +image_with+ but raises an error if no button matches +criteria+

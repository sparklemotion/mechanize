...
* Bug fixes
  ...
  * A jruby workaround for https://jira.codehaus.org/browse/JRUBY-6477 was
    added which allows mechanize to store large response bodies on disk.
    Issue #205 by tcpipmen
